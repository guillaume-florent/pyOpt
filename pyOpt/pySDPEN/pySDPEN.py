    ...
    def __init__(self, pll_type=None, *args, **kwargs):
        ...
        **Keyword arguments:**
        ...
        def_opts = {
            ...
            # Output Level (<0 - None,0 - Final, 1 - Iters, 2 - Full)
            'iprint': [int, 0],
        ...
        **Keyword arguments:**
        ...
        if self.poa:
            try:
                ...
                print('pySDPEN: Parallel objective Function Analysis '
                      'requires mpi4py')
        ...
        # Run SDPEN
        t0 = time.time()
        sdpen.penseq(n, m, xx, xl, xu, ff, gg, alfa_stop, nf_max, iprint, iout,
                     ifile, istop, nfvals, fobcon)
