    ...
    def __init__(self, pll_type=None, *args, **kwargs):
        ...
        **Keyword arguments:**
        ...
        def_opts = {
            ...
            'maxIt': [int, 500],
            # Output Level (0 - None, 1 - Final, 2 - Major,
            #               3 - Major/Minor, 4 - Full)
            'iPrint': [int, 2],
            # NLPQL Mode (0 - Normal Execution, 1 to 18 - See Manual)
            'mode': [int, 0],
            'iout': [int, 6],  # Output Unit Number
            # Merit Function Type
            # (True - L2 Augmented Penalty, False - L1 Penalty)
            'lmerit': [bool, True],
    ...
    def __solve__(self, opt_problem={}, sens_type='FD', store_sol=True,
        ...
        **Keyword arguments:**
        ...
        if self.poa and (sens_mode.lower() == 'pgc'):
            raise NotImplementedError("pyNLPQL - Current implementation only "
        ...
        if self.poa or (sens_mode.lower() == 'pgc'):
            try:
                ...
                print('pyNLPQL: Parallel objective Function Analysis '
                      'requires mpi4py')
        ...
        nlpql.nlpql1(mm, me, mmax, nn, nmax, mnn2, xx, ff, gg, df, dg, uu, xl,
                     xu, cc,
                     dd, acc, scbou, maxfun, maxit, iprint, mode, iout, ifile,
                     ifail,
                     wa, lwa, kwa, lkwa, active, lactiv, lmerit, lql, fmp,
                     nlfunc, nlgrad)
