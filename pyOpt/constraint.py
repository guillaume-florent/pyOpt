...
class Constraint(object):
    ...
    def __init__(self, name, type_='i', **kwargs):
        ...
        **Keyword arguments:**
        ...
        - type -> STR: Variable Type ('i'-inequality, 'e'-equality),
                  *Default* = 'i'
        ...
        if type_[0].lower() == 'i':
            ...
            raise IOError('Constraint type not understood -- '
                          'use either i(nequality) or e(quality)')
