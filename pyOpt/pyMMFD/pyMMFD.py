...
class MMFD(Optimizer):
    ...
    def __init__(self, pll_type=None, *args, **kwargs):
        ...
        **Keyword arguments:**
        ...
        def_opts = {
            # Feasible Directions Approach (0 - MMFD, 1 - MFD)
            'IOPT': [int, 0],
            ...
            # Objective Absolute Tolerance (DABOBJ*abs(f(x)))
            'DABOBJ': [float, 1e-3],
            ...
            # consecutive Iterations Iterations for Convergence
            'ITRMOP': [int, 3],
            # Print Control (0 - None, 1 - Final, 2 - Iters)
            'IPRINT': [int, 2],
    ...
    def __solve__(self, opt_problem, sens_type='FD', store_sol=True,
        ...
        **Keyword arguments:**
        ...
        mmfd.mmfd(iopt, ioned, iprint, ndv, ncn, xx, xl, xu, ff, gg, idg,
                  wk, nrwk, iwk, nriwk, ifile, ct, ctmin, dabobj, delobj,
                  thetaz,
