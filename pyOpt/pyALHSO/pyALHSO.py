        ...
        **Keyword arguments:**
        ...
        if self.poa:
            try:
                ...
                print('pyALHSO: Parallel objective Function Analysis'
                      'requires mpi4py')
        ...
        bw = (xu - xl) / dbw
        if myrank == 0:
            if (self.options['fileout'][1] >= 0 and self.options['fileout'][
                1] <= 2):
        ...
        # Run ALHSO
        t0 = time.time()
        opt_x, opt_f, opt_g, opt_lambda, nfevals, rseed = alhso.alhso(n,
                                                                      m,
                                                                      me,
                                                                      type,
                                                                      xs,
...
class HSO(Optimizer):
    ...
    def __init__(self, *args, **kwargs):
        ...
        def_opts = {
            ...
            'maxiter': [int, 1e4],
            # Flag to Turn On Information Output
            'printout': [int, 0],
            # Initial Position Flag (0 - no position, 1 - position given)
            'xinit': [int, 0],
            # Random Number Seed (0 - Auto-Seed based on time clock)
    ...
    def __solve__(self,
        ...
        # Run HSO
        t0 = time.time()
        opt_x, opt_f, opt_g, nfevals, rseed = alhso.chso(n,
                                                         m,
                                                         me,
                                                         type,
                                                         xs,
